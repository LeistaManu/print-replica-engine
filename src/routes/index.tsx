    ...
    <div className="min-h-screen animate-page-in overflow-x-hidden">
      ...
      <nav className="flex items-center justify-between px-6 py-5 md:px-12">
        ...
        <div className="flex items-center gap-2 animate-fade-up">
          ...
          >
            Old Account Login <ArrowRight className="h-4 w-4" />
          </a>
          <a
            href="#signup"
            onClick={handleSignup}
            className="hidden sm:inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-semibold hover:opacity-95 transition-all"
          >
            Sign Up
          </a>
        </div>
